...
Mark, Shell Navigation, not submitted
Lee, Shell Navigation, submitted
Johny, Shell Navigation, not submitted
Jaehyun, Shell Navigation, not submitted
EOF
...
echo "CHECK NOW ./submission_reminder_app/startup.sh AND LOOK"
